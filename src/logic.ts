...
let sounds: Sounds = {
    ...
    hit1: "assets/sounds/hit1.mp3",
    hit2: "assets/sounds/hit2.mp3",
    hit3: "assets/sounds/hit3.mp3",
    deathHit: "assets/sounds/deathHit.mp3",
    intro: "assets/sounds/intro.mp3",
    introAlt: "assets/sounds/introAlt.mp3",
    music: "assets/sounds/musicAlt.mp3"
}
...
const setGamePosition = () => {    
    ...
    const left = (bodyWidth - canvasWidth) / 2;
    const top = (bodyHeight - canvasHeight) / 2;
...
const ctrlStartEvent = (x: number, y: number) => {
    setGamePosition();
    mouseDown = true;
...
const ctrlMoveEvent = (x: number, y: number) => {
    setGamePosition();
...
const initializeControls = () => {    
    if (isMobileDevice) {
        ...
        gameCanvas.addEventListener('touchmove', (e: TouchEvent) => {
            e.preventDefault();
            ctrlMoveEvent(e.touches[0].clientX,e.touches[0].clientY);
        });
    } else {
        gameCanvas.addEventListener('mousedown', (e: MouseEvent) => {
            e.preventDefault();
            ctrlStartEvent(e.clientX,e.clientY);
        });
        ...
        gameCanvas.addEventListener('mousemove', (e: MouseEvent) => {
            e.preventDefault();
            ctrlMoveEvent(e.clientX,e.clientY);
        });
    }
